...
public class SwffgPlugin : ICodexSystemPlugin
{
    ...
    public IEnumerable<UISchema> GetUISchemas()
    {
        ...
        yield return new UISchema(
            ...
            {
                new("Planet", "Globe", "#3498db", new List<GraphEdgeSchema> { new GraphEdgeSchema("Hyperspace", "Hyperspace", "Planet", true) }),
                new("Station", "Server", "#95a5a6", new List<GraphEdgeSchema> { new GraphEdgeSchema("Dock", "Dock", "Planet") })
            }
        );
    }
}
